...
<html lang="sv">
 <head>
 <meta charset="UTF-8">
 <title>Förklaring av regler</title>
</haed>
  
 <img src="docs/img/cotc-logo.png" style=display:block; margin:auto;>


 <body>
  <h1>Förklaring av regler</h1>
  <p>Detta är en sammanställning som förklarar i huvudsak allt som nya spelare behöver veta för att kunna börja spela **Counsil of the Clocktower**.
...
<img src="docs/img/manus-tb.png" style=display:block; margin:auto;>
